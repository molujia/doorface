document.addEventListener("DOMContentLoaded", function () {
  ...
  const animateOnScroll = () => {
    const elements = document.querySelectorAll('.feature-card, .advantage-item, .arch-item, .scenario-card');
  ...
  // 初始化元素样式
  document.querySelectorAll('.feature-card, .advantage-item, .arch-item, .scenario-card').forEach(element => {
